...
public class AuthService {
    ...
    private AuthToken applyToken(String username, String password, String clientId, String clientSecret) {
        ...
        if (bodyMap == null || bodyMap.get("access_token") == null || bodyMap.get("refresh_token") == null || bodyMap.get("jti") == null) {//jti是jwt令牌的唯一标识作为用户身份令牌
     ...
     * @param cookie
     */
    public boolean delToken(String cookie) {
