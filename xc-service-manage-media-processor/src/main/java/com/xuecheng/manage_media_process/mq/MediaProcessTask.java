...
public class MediaProcessTask {
    ...
    public void receiveMediaProcessTask(String msg) { //msg就是媒资信息的主键
        //1. 解析内容 得到mediaID
        Map map = JSON.parseObject(msg, Map.class);
        String mediaId = (String) map.get("mediaId");
        //2. 拿mediaID从数据库得到文件的信息
        ...
        //3. 使用工具类将AVI文件转成MP4
        //确定这几个路径: String ffmpeg_path, String video_path, String mp4_name, String mp4folder_path
        //要处理的视频文件的路径
        ...
        //4. 将MP4转成m3u8和ts文件
        //定义路径String ffmpeg_path, String video_path, String m3u8_name,String m3u8folder_path
        //MP4的文件路径
